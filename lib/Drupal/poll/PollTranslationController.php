...
/**
 * @file
 * Definition of Drupal\poll\PollTranslationController.
 */
 ...
 */
class PollTranslationController extends ContentTranslationController {
...
//    $type_name = poll_get_type_label($entity);
